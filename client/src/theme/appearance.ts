...
export const WORKSPACE_BACKGROUNDS: WorkspaceBackground[] = [
  {
    ...
    canvas: "oklch(8.5% 0.004 260)",
    canvasDark: "oklch(6.5% 0.004 260)",
    dots: "oklch(22% 0.006 260)",
    controls: "oklch(13% 0.005 260)",
    border: "oklch(24% 0.007 260)",
    preview: ["oklch(8.5% 0.004 260)", "oklch(14% 0.006 260)", "oklch(68% 0.15 48)"],
  },
  {
    id: "moss",
    name: "Moss",
